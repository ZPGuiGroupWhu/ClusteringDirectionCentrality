...
for i=1:n
    if(a3(i)==0||a3(i)==-1)
        ...
        hold on;
    elseif(a3(i)==2)
        plot(X(i,1),X(i,2),'o','markerfacecolor',[0.9,0.1,0.1],'markeredgecolor',[0.9,0.1,0.1],'markersize',5);
        hold on;
    elseif(a3(i)==3)
...
%         hold on;
          plot(X(i,1),X(i,2),'o','markerfacecolor',[1,0.6,0],'markeredgecolor',[1,0.6,0],'markersize',5);
          hold on;
    elseif(a3(i)==1)
    ...
    elseif(a3(i)==5)
        ...
        hold on;
    elseif(a3(i)==6)
        plot(X(i,1),X(i,2),'o','markerfacecolor',[0.9,0.2,0.5],'markeredgecolor',[0.9,0.2,0.5],'markersize',5);
        hold on;
    elseif(a3(i)==7)
        plot(X(i,1),X(i,2),'o','markerfacecolor',[1,0.6,0],'markeredgecolor',[1,0.6,0],'markersize',5);
        hold on;
    elseif(a3(i)==8)
        plot(X(i,1),X(i,2),'o','markerfacecolor',[0.1,0.8,0.1],'markeredgecolor',[0.1,0.8,0.1],'markersize',5);
        hold on;
    elseif(a3(i)==10)
        plot(X(i,1),X(i,2),'o','markerfacecolor',[0,0,0.8],'markeredgecolor',[0,0,0.8],'markersize',5);
        hold on;
     elseif(a3(i)==9)
         plot(X(i,1),X(i,2),'o','markerfacecolor',[0.8,0.5,0.1],'markeredgecolor',[0.8,0.5,0.1],'markersize',5);
         hold on;
    elseif(a3(i)==11)
