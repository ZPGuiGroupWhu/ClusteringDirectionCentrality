        ...
        implements Serializable
{
    ...
    private static final int GRID_RESOLUTION = Short.MAX_VALUE;//32767
...
//
//        System.out.println("----------打印分区----------");
//        this.grids.forEach(System.out::println);
    }
...
//        System.out.println("hValue "+hValue+" Partition "+partition);
        return partition;
    }
...
//        int x = locationMapping(boundary.getMinX(), boundary.getMaxX(), (spatialObject.getMinX() + spatialObject.getMaxX()) / 2.0);
        int x = locationMapping(boundary.getMinX(), (spatialObject.getMinX() + spatialObject.getMaxX()) / 2.0,boundary.getMaxX());
//        int y = locationMapping(boundary.getMinY(), boundary.getMaxY(), (spatialObject.getMinY() + spatialObject.getMaxY()) / 2.0);        int x = locationMapping(boundary.getMinX(), boundary.getMaxX(), (spatialObject.getMinX() + spatialObject.getMaxX()) / 2.0);
        int y = locationMapping(boundary.getMinY(), (spatialObject.getMinY() + spatialObject.getMaxY()) / 2.0,boundary.getMaxY());
    ...
    /**
     * Creates the partitions from H values.
     *
