...
import com.yolo.CDC.java.index.IndexBuilder;
import com.yolo.CDC.java.partitioner.*;
import com.yolo.CDC.java.partitioner.quadtree.QuadTreePartitioner;
import com.yolo.CDC.java.partitioner.quadtree.StandardQuadTree;
import com.yolo.CDC.java.type.GridType;
import com.yolo.CDC.java.type.IndexType;
import com.yolo.CDC.java.utils.GeomUtils;
import com.yolo.CDC.java.utils.RDDSampleUtils;
    ...
    public void spatialPartitioning(GridType gridType, int numPartitions)
        ...
        switch (gridType) {
            ...
            case Hilbert: {
                ...
                partitioner = new FlatGridPartitioner(hilbertPartitioning.getGrids());
                break;
            }
            case STRTREE: {
                RtreePartitioning rtreePartitioning = new RtreePartitioning(samples, numPartitions);
                partitioner = new FlatGridPartitioner(rtreePartitioning.getGrids());
                break;
            }
            case Equal: {
            ...
            case Voronoi: {
                ...
                partitioner = new FlatGridPartitioner(voronoiPartitioning.getGrids());
                break;
            }
            default:
                throw new Exception("[AbstractSpatialRDD][spatialPartitioning] Unsupported spatial partitioning method. " +
                        "The following partitioning methods are not supported");
        }
